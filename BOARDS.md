...
```
    ...
    COLLEGATO A USB OTG ?    GPIO 20 |-)            (x| GPIO 13
                             GPIO 21 |-)            (p| GPIO 12
                             GPIO 47 |-)            (x| GPIO 11
       COLLEGATO AL LED RGB  GPIO 48 |-)            (-| GPIO 10
                             GPIO 45 |x)            (x| GPIO  9
  COLLEGATO A PULSANTE BOOT  GPIO  0 |-)            (-| GPIO 46
                             GPIO 35 |-)            (-| GPIO  3 USATO PER USB SERIALE JTAG ?
                             GPIO 36 |-)            (x| GPIO  8
                             GPIO 37 |-)            (-| GPIO 18
                             GPIO 38 |x)            (x| GPIO 17
                             GPIO 39 |-)            (-| GPIO 16
                             ...
                             GPIO  2 |x)            (x| GPIO  5
                             GPIO  1 |-)            (-| GPIO  4
COLLEGATO A USB SERIAL JTAG U0RXD RX |x)            (x| RST CHIP PU COLLEGATO A PULSANTE RST
COLLEGATO A USB SERIAL JTAG U0TXD TX |-)            (-| 3V3 VDD33
                                 GND |-)            (-| 3V3 VDD33
                                     |____ANTENNA_____|  
